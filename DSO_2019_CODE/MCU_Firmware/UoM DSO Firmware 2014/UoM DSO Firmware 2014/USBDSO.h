...
#define RAM_READ(STATE) SET(PORTD,_BV(PB4),STATE)
#define RAM_READ_DDR(DIR) SET(DDRD,_BV(PB4),DIR)
#define RAM_READ_IN GET(PIND,_BV(PB4))

#define FORCE(STATE) SET(PORTC,_BV(PC6),STATE)
#define FORCE_DDR(DIR) SET(DDRC,_BV(PC6),DIR)
#define FORCE_IN GET(PINC,_BV(PC6))

#define TRIGGER_BTN(STATE) SET(PORTB,_BV(PD3),STATE)
#define TRIGGER_BTN_DDR(DIR) SET(DDRB,_BV(PD3),DIR)
#define TRIGGER_BTN_IN GET(PINB,_BV(PD3))

#define ENABLE(STATE) SET(PORTC,_BV(PD7),STATE)
#define ENABLE_DDR(DIR) SET(DDRC,_BV(PD7),DIR)
#define ENABLE_IN GET(PINC,_BV(PD7))

#define EDGE_SWITCH(STATE) SET(PORTD,_BV(PC0),STATE)
#define EDGE_SWITCH_DDR(DIR) SET(DDRD,_BV(PC0),DIR)
#define EDGE_SWITCH_IN GET(PIND,_BV(PC0))
...
#define SCS(STATE) SET(PORTB,_BV(PC6),STATE)
#define SCS_DDR(DIR) SET(DDRB,_BV(PC6),DIR)
#define SCS_IN GET(PINB,_BV(PC6))	
...
#define SLOW_CLK(STATE) SET(PORTC,_BV(PB3),STATE) // Databuffer read clocking signal
#define SLOW_CLK_DDR(DIR) SET(DDRC,_BV(PB3),DIR)
#define SLOW_CLK_IN GET(PINC,_BV(PB3))	

#define FILL_COMP(STATE) SET(PORTC,_BV(PD2),STATE)
#define FILL_COMP_DDR(DIR) SET(DDRC,_BV(PD2),DIR)
#define FILL_COMP_IN GET(PINC,_BV(PD2))	
